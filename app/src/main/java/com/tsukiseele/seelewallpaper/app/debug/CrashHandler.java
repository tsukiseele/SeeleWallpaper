...
public class CrashHandler implements UncaughtExceptionHandler {  
     ...
     * @param context 
     */  
    public void init(Application al) {  
        mContext = al.getApplicationContext(); 
    ...
    private boolean handleException(final Throwable ex) {  
        ...
        new Thread(new Runnable() {
            ...
            public void run() {  
                ...
                ToastUtil.makeText(mContext, "很抱歉,程序出现异常,即将退出.\n" + sw.toString(), ToastUtil.LENGTH_LONG).show();
				Logger.e("崩溃信息", sw.toString());
    ...
    private String saveCrashInfoToFile(Throwable ex) {  
        ...
        try {  
            ...
            //if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {  
                String path = Const.DEBUG_CRACHLOG_DIRECTORY.toString();  
